...
\begin{frame}{Cálculo da Aceleração da Gravidade}
    ...
    %     $$g_{\text{medio}} = \frac{9,78 + 9,78}{2} = 9,78 \text{ m/s}^2$$
    %     Erro relativo: $\frac{|9,78 - 9,81|}{9,81} \times 100\% = 0,3\%$
    % \end{alertblock}
\end{frame}
...
\begin{frame}{Análise dos Resultados}
    ...
    %     \item \textbf{Resultado para 30°:} $g = 9,78 \text{ m/s}^2$ %(erro: 0,3\%)
    %     \item \textbf{Resultado para 60°:} $g = 9,78 \text{ m/s}^2$ %(erro: 0,3\%)
    %     \item \textbf{Valor médio:} $g = 9,78 \text{ m/s}^2$ (erro: 0,3\%)
    % \end{itemize}
